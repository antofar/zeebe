...
public class TypedStreamWriterImpl implements TypedStreamWriter, TypedBatchWriter
{
    ...
    @Override
    public long writeCommand(long key, Intent intent, UnpackedObject value, Consumer<RecordMetadata> metadata)
    {
    ...
    @Override
    public long writeEvent(long key, Intent intent, UnpackedObject value, Consumer<RecordMetadata> metadata)
    {
    ...
    @Override
    public TypedBatchWriter addCommand(Intent intent, UnpackedObject value)
    {
        return addRecord(-1, RecordType.COMMAND, intent, value, noop);
    }

    @Override
    public TypedBatchWriter addCommand(long key, Intent intent, UnpackedObject value)
    {
        return addRecord(key, RecordType.COMMAND, intent, value, noop);
    }

    @Override
    public TypedBatchWriter addEvent(Intent intent, UnpackedObject value)
    {
        return addRecord(-1, RecordType.EVENT, intent, value, noop);
    }

    @Override
    public TypedBatchWriter addEvent(long key, Intent intent, UnpackedObject value)
    {
